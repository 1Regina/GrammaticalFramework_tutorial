concrete MiniGrammarEng of MiniGrammar = open MiniResEng, Prelude in {
  ...
  lin
    ...
    ReflV2 v2 = {
      verb = verb2gverb v2 ;
      compl = table {
                Agr Sg Per1 => {-v2.c ++ -} "myself" ; {-if i want to do for myself. believe in myself. But where its NA e.g feed, see myself, the c will be empty-}
      ...
      {- to avoid repeat v2.c ++ "myself" v2.c ++ "yourself" etc:
       compl =
         let reflPron : Agreement => Str = table {
                ...
                Agr Pl Per2 => "yourselves" ;
                Agr Pl Per3 => "themselves" } ;
          in \\a => v2.c ++ retflPron ! a; {-sugared form-}
      -}
      {- table { a => v2.c ++ reflPron ! a} -} {-desugared form-}
